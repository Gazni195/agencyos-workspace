...
function DocumentsPage() {
  return <section className="mx-auto max-w-7xl"><PageHeader title="Documents" description="Keep contracts, policies and employee files organized." /><div className="grid gap-4 sm:grid-cols-3"><KpiCard label="All documents" value="24" icon={FileText} /><KpiCard label="Folders" value="6" icon={FolderOpen} /><KpiCard label="Needs upload" value="4" icon={Upload} /></div><div className="surface-card mt-5 p-5"><p className="font-semibold">Employee document library</p><p className="mt-2 text-sm text-muted-foreground">Secure document records are ready for upload and review.</p></div></section>;
}